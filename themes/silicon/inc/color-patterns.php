 ...
 */
function silicon_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Silicon default saturation level.
	 *
	 * @since Silicon 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'silicon_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.silicon-front-page) .entry-title,
...
.colors-custom .silicon-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.silicon-front-page .panel-content .recent-posts article,
...
.colors-custom.silicon-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Silicon custom colors CSS.
	 *
	 * @since Silicon 1.0
	 *
	 ...
	 */
	return apply_filters( 'silicon_custom_colors_css', $css, $hue, $saturation );
}
